...
\begin{proof}
   ...
   enaka številu $\m 2(n)$. % sklica: eq:numbers, eq:numbers
% Konec dokaza
\end{proof}
...
Števila različnih normalnih magičnih kvadratov se nahajajo v tabeli \ref{table:mag3}.
% sklic: table:stevila
...
\begin{table}[!ht]
   \centering
   \caption{Število različnih magičnih kvadrantov}
   \begin{tabular}{|l|c|c|c|c|c|c|}\toprule
      & \multicolumn{5}{c}{texttočna vrednost} & približek \\\midrule
      red & 1 & 2 & 3 & 4 & 5 & 6 \\
